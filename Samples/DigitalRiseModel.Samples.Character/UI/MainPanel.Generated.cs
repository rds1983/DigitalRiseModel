/* Generated by MyraPad at 5/16/2026 4:46:17 AM */
using Myra;
...
namespace DigitalRiseModel.Samples.Character.UI
{
	partial class MainPanel: Panel
	{
		private void BuildUI()
		{
			...
			label3.Text = "Escape - Turn Mouse Lock On/Off";

			var label4 = new Label();
			label4.Text = "R - Draw/Sheath Weapon";

			var label5 = new Label();
			label5.Text = "Left Shift - Slash Weapon";
