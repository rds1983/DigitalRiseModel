...
namespace NursiaModel.Primitives
{
	partial class MeshPrimitives
	{
		...
		/// <returns>A new <see cref="NrmMeshPart"/> that represents a hemisphere line list.</returns>
		/// <remarks>
		/// If the returned <see cref="NrmMeshPart"/> is not going to be modified, then it is better
		/// to call <see cref="GetHemisphereLines"/> to retrieve a shared <see cref="NrmMeshPart"/> instance.
		/// </remarks>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="numberOfSegments"/> is less than or equal to 2.
		/// </exception>
		public static NrmMeshPart CreateHemisphereLinesMeshPart(GraphicsDevice graphicsDevice, int numberOfSegments = 32)
		{
