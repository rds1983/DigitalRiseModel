...
namespace DigitalRiseModel.Primitives
{
	...
	{
		/// <summary>
		/// Creates a new meshpart that represents a cylinder using lines.
		...
		/// <returns>A new <see cref="NrmMeshPart"/> that represents a cylinder line list.</returns>
		/// <remarks>
		/// If the returned <see cref="NrmMeshPart"/> is not going to be modified, then it is better
		/// to call <see cref="GetCylinderLines"/> to retrieve a shared <see cref="NrmMeshPart"/> instance.
		/// </remarks>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="numberOfSegments"/> is less than or equal to 2.
		/// </exception>
		public static NrmMeshPart CreateCylinderLinesMeshPart(GraphicsDevice graphicsDevice, int numberOfSegments = 32)
		{
